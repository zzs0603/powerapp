 ...
 * @param  mode 0: normal initialization, 1: enforce formatting
...
//    if (mode >= 1)
//    {
//        status |= dbg_log("Page 0 (0x%08x):\n",PAGE0_BASE_ADDRESS);
//        status |= MIOS32_MIDI_SendDebugHexDump((u8 *) PAGE0_BASE_ADDRESS,
//                PAGE_SIZE);
//        status |= MIOS32_MIDI_SendDebugMessage("Page 1 (0x%08x):\n",
//                PAGE1_BASE_ADDRESS);
//        status |= MIOS32_MIDI_SendDebugHexDump((u8 *) PAGE1_BASE_ADDRESS,
//                PAGE_SIZE);
//    }
//
//    if (mode != 1)
...
//        status |= MIOS32_MIDI_SendDebugHexDump(buffer,
//                2 * EEPROM_EMULATED_SIZE);
//    }
//
    return status;
}
